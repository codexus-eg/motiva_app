...
class VendorCompletedRequestCard extends ConsumerWidget {
  final VendorOrder order;

  const VendorCompletedRequestCard({super.key, required this.order});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _infoRow(
            t.completed,
            _formatTime(order.completedAt ?? order.updatedAt),
            context,
          ),
