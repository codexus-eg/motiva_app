...
/// The unified Orders tab screen.
/// Embedded in the vendor home bottom nav. Shows both service and product orders.
/// A+ Design: spacious layout, breathing room, visual hierarchy.
class VendorOrdersTabScreen extends ConsumerStatefulWidget {
  const VendorOrdersTabScreen({super.key});

  @override
  ConsumerState<VendorOrdersTabScreen> createState() =>
      _VendorOrdersTabScreenState();
}

class _VendorOrdersTabScreenState extends ConsumerState<VendorOrdersTabScreen>
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        t.vendor_dashboard.orders.tab_title,
                      ...
                      const Gap(4),
                      Text(
                        t.vendor_dashboard.orders.tab_subtitle,
                        style: GoogleFonts.poppins(
  ...
  Widget _buildLiveBadge() {
    ...
    int total = 0;
    serviceAsync.whenData((d) => total += d.length);
    productAsync.whenData((d) => total += d.length);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const Gap(6),
          Text(
            t.vendor_dashboard.orders.live_badge.replaceAll('{count}', total.toString()),
