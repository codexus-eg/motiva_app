...
class DamagedConditionCarsScreen extends ConsumerStatefulWidget {
  const DamagedConditionCarsScreen({super.key});

  @override
  ConsumerState<DamagedConditionCarsScreen> createState() =>
      _DamagedConditionCarsScreenState();
}

class _DamagedConditionCarsScreenState
    extends ConsumerState<DamagedConditionCarsScreen> {
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  Timer? _debounceTimer;
  static const String _conditionFilter = 'DAMAGED';
  String _searchQuery = '';
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Gap(AppSpacing.xl),
                          Text(
                            t.buy_a_car.damaged_cars_screen.title,
                      ...
                      CustomSearchBar(
                        ...
                        hintText: t.buy_a_car.damaged_cars_screen.search_hint,
                        isBuyCar: true,
                      ...
                      Gap(AppSpacing.lg),
                      Text(
                        t.buy_a_car.damaged_cars_screen.all_damaged_cars,
                        style: GoogleFonts.poppins(
                          color: theme.colorScheme.onSurface,
                          fontSize: 16,
                    ...
                    children: [
                      ...
                      Text(
                        _searchQuery.isNotEmpty
                            ? t.buy_a_car.damaged_cars_screen.no_cars_found
                            : t
                                  .buy_a_car
                                  .damaged_cars_screen
                                  .no_damaged_cars_available,
                        style: GoogleFonts.poppins(
                          color: Colors.grey[600],
                          fontSize: 16,
                        ),
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(t.buy_a_car.damaged_cars_screen.retry),
                    ),
                  ],
                ),
              ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Gap(AppSpacing.md),
                Text(
                  t.buy_a_car.damaged_cars_screen.failed_to_load,
                  style: GoogleFonts.poppins(
                    color: Colors.red[400],
                    fontSize: 16,
                  ),
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    t.buy_a_car.damaged_cars_screen.retry,
