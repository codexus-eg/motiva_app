...
class ApprovedCarsScreen extends ConsumerStatefulWidget {
  const ApprovedCarsScreen({super.key});

  @override
  ConsumerState<ApprovedCarsScreen> createState() => _ApprovedCarsScreenState();
}

class _ApprovedCarsScreenState extends ConsumerState<ApprovedCarsScreen> {
  final ScrollController _scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  Timer? _debounceTimer;
  static const String _statusFilter = 'ACTIVE';
  String _searchQuery = '';
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Gap(AppSpacing.xl),
                          Text(
                            t.buy_a_car.approved_cars_screen.title,
                      ...
                      CustomSearchBar(
                        ...
                        hintText: t.buy_a_car.approved_cars_screen.search_hint,
                        isBuyCar: true,
                      ...
                      Gap(AppSpacing.lg),
                      Text(
                        t.buy_a_car.approved_cars_screen.all_approved_cars,
                        style: GoogleFonts.poppins(
                          color: theme.colorScheme.onSurface,
                          fontSize: 16,
                    ...
                    children: [
                      ...
                      Text(
                        _searchQuery.isNotEmpty
                            ? t.buy_a_car.approved_cars_screen.no_cars_found
                            : t
                                  .buy_a_car
                                  .approved_cars_screen
                                  .no_approved_cars_available,
                        style: GoogleFonts.poppins(
                          color: Colors.grey[600],
                          fontSize: 16,
                        ),
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(t.buy_a_car.approved_cars_screen.retry),
                    ),
                  ],
                ),
              ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Gap(AppSpacing.md),
                Text(
                  t.buy_a_car.approved_cars_screen.failed_to_load,
                  style: GoogleFonts.poppins(
                    color: Colors.red[400],
                    fontSize: 16,
                  ),
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    t.buy_a_car.approved_cars_screen.retry,
