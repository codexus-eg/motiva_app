import 'package:app/features/sell_your_car/damaged_car/presentation/screens/damaged_car_details_screen.dart';
...
class ServiceCcSection extends StatelessWidget {
  const ServiceCcSection({super.key});
          ...
          ServiceCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const GoodCarDetailsScreen(),
                ),
              );
            },
          ),
          ...
          ServiceCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DamagedCarDetailsScreen(),
                ),
              );
            },
          ),
