...
class MileageGCTab extends ConsumerStatefulWidget {
  final void Function(int mileage) onMileageEntered;

  const MileageGCTab({super.key, required this.onMileageEntered});

  @override
  ConsumerState<MileageGCTab> createState() => _MileageGCTabState();
}

class _MileageGCTabState extends ConsumerState<MileageGCTab> {
  String mileage = '';
