...
class MakeGCTab extends ConsumerStatefulWidget {
  final void Function(CarMake make) onMakeSelected;

  const MakeGCTab({super.key, required this.onMakeSelected});

  @override
  ConsumerState<MakeGCTab> createState() => _MakeGCTabState();
}

class _MakeGCTabState extends ConsumerState<MakeGCTab> {
  String searchQuery = '';
