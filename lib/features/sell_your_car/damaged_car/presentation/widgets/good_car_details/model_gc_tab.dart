...
class ModelGCTab extends ConsumerStatefulWidget {
  final void Function(CarModel model) onModelSelected;

  const ModelGCTab({super.key, required this.onModelSelected});

  @override
  ConsumerState<ModelGCTab> createState() => _ModelGCTabState();
}

class _ModelGCTabState extends ConsumerState<ModelGCTab> {
  String searchQuery = '';
