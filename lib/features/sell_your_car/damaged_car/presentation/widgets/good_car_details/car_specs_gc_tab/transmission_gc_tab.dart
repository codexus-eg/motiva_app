...
class TransmissionGCTab extends ConsumerStatefulWidget {
  final VoidCallback onContinue;
  final void Function(String transmission) onTransmissionSelected;

  const TransmissionGCTab({
    super.key,
  ...
  @override
  ConsumerState<TransmissionGCTab> createState() => _TransmissionGCTabState();
}

class _TransmissionGCTabState extends ConsumerState<TransmissionGCTab> {
  String selected = '';
