...
class YearGCTab extends ConsumerStatefulWidget {
  final void Function(int year) onYearSelected;

  const YearGCTab({super.key, required this.onYearSelected});

  @override
  ConsumerState<YearGCTab> createState() => _YearGCTabState();
}

class _YearGCTabState extends ConsumerState<YearGCTab> {
  String year = '';
  String? _yearError;
