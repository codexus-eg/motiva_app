...
class MileageTab extends ConsumerStatefulWidget {
  final void Function(int mileage) onMileageEntered;

  const MileageTab({super.key, required this.onMileageEntered});

  @override
  ConsumerState<MileageTab> createState() => _MileageTabState();
}

class _MileageTabState extends ConsumerState<MileageTab> {
  String mileage = '';
