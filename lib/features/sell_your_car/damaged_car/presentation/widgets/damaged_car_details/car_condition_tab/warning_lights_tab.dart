...
class WarningLightsTab extends StatefulWidget {
  final VoidCallback onContinue;
  final void Function(String value) onWarningLightsSelected;

  const WarningLightsTab({
    super.key,
  ...
  @override
  State<WarningLightsTab> createState() => _WarningLightsTabState();
}

class _WarningLightsTabState extends State<WarningLightsTab> {
  String selected = '';
