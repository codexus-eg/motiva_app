...
class TransmissionTab extends StatefulWidget {
  ...
  @override
  State<TransmissionTab> createState() => _TransmissionTabState();
}

class _TransmissionTabState extends State<TransmissionTab> {
  String selected = '';
  ...
  Widget _buildOption(String value) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (value.isNotEmpty) {
          widget.onTransmissionSelected(value.toUpperCase());
          widget.onContinue();
        }
      },
