...
class PaintConditionTab extends StatefulWidget {
  ...
  @override
  State<PaintConditionTab> createState() => _PaintConditionTabState();
}

class _PaintConditionTabState extends State<PaintConditionTab> {
