...
class MakeTab extends ConsumerStatefulWidget {
  final void Function(CarMake make) onMakeSelected;

  const MakeTab({super.key, required this.onMakeSelected});

  @override
  ConsumerState<MakeTab> createState() => _MakeTabState();
}

class _MakeTabState extends ConsumerState<MakeTab> {
  String searchQuery = '';
