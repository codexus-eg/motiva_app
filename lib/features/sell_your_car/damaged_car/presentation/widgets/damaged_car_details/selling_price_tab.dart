...
class SellingPriceTab extends ConsumerStatefulWidget {
  final void Function(double price) onPriceEntered;

  const SellingPriceTab({super.key, required this.onPriceEntered});

  @override
  ConsumerState<SellingPriceTab> createState() => _SellingPriceTabState();
}

class _SellingPriceTabState extends ConsumerState<SellingPriceTab> {
  String sellingPrice = '';
