...
class FtTrimDCTab extends ConsumerStatefulWidget {
  final void Function(CarTrim trim) onTrimSelected;

  const FtTrimDCTab({super.key, required this.onTrimSelected});

  @override
  ConsumerState<FtTrimDCTab> createState() => _FtTrimDCTabState();
}

class _FtTrimDCTabState extends ConsumerState<FtTrimDCTab> {
  String searchQuery = '';
