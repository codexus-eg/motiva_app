...
class FtTransmissionDCTab extends StatefulWidget {
  final VoidCallback onContinue;
  final void Function(String transmission) onTransmissionSelected;

  const FtTransmissionDCTab({
    super.key,
  ...
  @override
  State<FtTransmissionDCTab> createState() => _FtTransmissionDCTabState();
}

class _FtTransmissionDCTabState extends State<FtTransmissionDCTab> {
  String selected = '';
          ...
          GradientButton(
            onTap: () {
              if (selected.isNotEmpty) {
                widget.onTransmissionSelected(selected);
                widget.onContinue();
              }
            },
  ...
  Widget _buildOption(String value) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        widget.onTransmissionSelected(value);
      },
