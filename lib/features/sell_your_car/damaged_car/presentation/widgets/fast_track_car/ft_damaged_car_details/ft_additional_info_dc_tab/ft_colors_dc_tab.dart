...
class FtColorsDCTab extends StatefulWidget {
  final VoidCallback onContinue;

  const FtColorsDCTab({super.key, required this.onContinue});

  @override
  State<FtColorsDCTab> createState() => _FtColorsDCTabState();
}

class _FtColorsDCTabState extends State<FtColorsDCTab> {
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        ...
                        if (isSelected)
                          Icon(Icons.check, color: theme.onSurface, size: 22),
                      ],
                    ),
