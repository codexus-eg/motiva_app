...
class FtModelDCTab extends ConsumerStatefulWidget {
  final void Function(CarModel model) onModelSelected;

  const FtModelDCTab({super.key, required this.onModelSelected});

  @override
  ConsumerState<FtModelDCTab> createState() => _FtModelDCTabState();
}

class _FtModelDCTabState extends ConsumerState<FtModelDCTab> {
  String searchQuery = '';
