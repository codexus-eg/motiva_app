...
class FtWarningLightsDCTab extends StatefulWidget {
  final VoidCallback onContinue;
  final void Function(String value) onWarningLightsSelected;

  const FtWarningLightsDCTab({
    super.key,
  ...
  @override
  State<FtWarningLightsDCTab> createState() => _FtWarningLightsDCTabState();
}

class _FtWarningLightsDCTabState extends State<FtWarningLightsDCTab> {
  String selected = '';
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  Translations.of(
                    context,
                  ).sell_your_car.car_condition.warning_lights_title,
                  style: TextStyle(
          ...
          GradientButton(
            onTap: selected.isNotEmpty
                ? () {
                    widget.onWarningLightsSelected(selected);
                    widget.onContinue();
                  }
                : null,
  ...
  Widget _buildOption(String value) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        widget.onWarningLightsSelected(value);
      },
