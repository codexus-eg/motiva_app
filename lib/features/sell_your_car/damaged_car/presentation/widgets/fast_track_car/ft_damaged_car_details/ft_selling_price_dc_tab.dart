...
class FtSellingPriceDCTab extends ConsumerStatefulWidget {
  final void Function(double price) onPriceEntered;

  const FtSellingPriceDCTab({super.key, required this.onPriceEntered});

  @override
  ConsumerState<FtSellingPriceDCTab> createState() =>
      _FtSellingPriceDCTabState();
}

class _FtSellingPriceDCTabState extends ConsumerState<FtSellingPriceDCTab> {
  String sellingPrice = '';
