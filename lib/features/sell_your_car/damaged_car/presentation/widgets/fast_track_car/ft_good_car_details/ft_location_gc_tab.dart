...
class FtLocationGcTab extends StatefulWidget {
  final VoidCallback onContinue;
  final void Function(String? locationCity)? onLocationSelected;

  const FtLocationGcTab({
    super.key,
  ...
  @override
  State<FtLocationGcTab> createState() => _FtLocationGcTabState();
}

class _FtLocationGcTabState extends State<FtLocationGcTab> {
