...
class FtDurationGCTab extends ConsumerStatefulWidget {
  final VoidCallback onSubmit;

  const FtDurationGCTab({super.key, required this.onSubmit});

  @override
  ConsumerState<FtDurationGCTab> createState() => _FtDurationGCTabState();
}

class _FtDurationGCTabState extends ConsumerState<FtDurationGCTab> {
