...
class FtImagesGCTab extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FtImagesGCTab> createState() => _FtImagesGCTabState();
}

class _FtImagesGCTabState extends ConsumerState<FtImagesGCTab> {
  ...
  Future<void> _onContinue() async {
    AppLogger.debug('=== FtImagesGCTab _onContinue called ===');
