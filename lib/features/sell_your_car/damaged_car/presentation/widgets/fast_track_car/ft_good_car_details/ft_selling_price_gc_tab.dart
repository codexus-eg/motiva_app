...
class FtSellingPriceGCTab extends ConsumerStatefulWidget {
  final void Function(double price) onPriceEntered;

  const FtSellingPriceGCTab({super.key, required this.onPriceEntered});

  @override
  ConsumerState<FtSellingPriceGCTab> createState() =>
      _FtSellingPriceGCTabState();
}

class _FtSellingPriceGCTabState extends ConsumerState<FtSellingPriceGCTab> {
  String sellingPrice = '';
