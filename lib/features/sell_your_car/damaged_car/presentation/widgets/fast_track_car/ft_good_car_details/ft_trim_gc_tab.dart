...
class FtTrimGCTab extends ConsumerStatefulWidget {
  final void Function(CarTrim trim) onTrimSelected;

  const FtTrimGCTab({super.key, required this.onTrimSelected});

  @override
  ConsumerState<FtTrimGCTab> createState() => _FtTrimGCTabState();
}

class _FtTrimGCTabState extends ConsumerState<FtTrimGCTab> {
  String searchQuery = '';
