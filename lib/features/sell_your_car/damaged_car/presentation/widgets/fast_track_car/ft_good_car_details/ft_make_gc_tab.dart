...
class FtMakeGCTab extends ConsumerStatefulWidget {
  final void Function(CarMake make) onMakeSelected;

  const FtMakeGCTab({super.key, required this.onMakeSelected});

  @override
  ConsumerState<FtMakeGCTab> createState() => _FtMakeGCTabState();
}

class _FtMakeGCTabState extends ConsumerState<FtMakeGCTab> {
  String searchQuery = '';
