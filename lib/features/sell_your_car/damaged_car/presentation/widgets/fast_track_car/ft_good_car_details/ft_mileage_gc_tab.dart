...
class FtMileageGCTab extends StatefulWidget {
  final void Function(int mileage) onMileageEntered;

  const FtMileageGCTab({super.key, required this.onMileageEntered});

  @override
  State<FtMileageGCTab> createState() => _FtMileageGCTabState();
}

class _FtMileageGCTabState extends State<FtMileageGCTab> {
  String mileage = '';
