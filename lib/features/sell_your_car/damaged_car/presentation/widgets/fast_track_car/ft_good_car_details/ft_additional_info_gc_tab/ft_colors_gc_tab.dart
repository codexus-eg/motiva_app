...
class FtColorsGCTab extends StatefulWidget {
  ...
  @override
  State<FtColorsGCTab> createState() => _FtColorsGCTabState();
}

class _FtColorsGCTabState extends State<FtColorsGCTab> {
        ...
        children: [
          ...
          ColorSection(
            ...
            onSelect: (color) {
              ...
              widget.onColorSelected(color.label);
              widget.onContinue();
            },
          ),
          ...
          GradientButton(
            ...
            onTap: isContinueEnabled ? () => widget.onContinue() : null,
          ),
          Gap(AppSpacing.lg),
        ],
      ),
